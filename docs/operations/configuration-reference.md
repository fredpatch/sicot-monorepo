...
11. **Root README states Node ≥ 22**, while CI and both Dockerfiles pin
    Node 20 and nothing enforces either number. See
    [installation-bootstrap.md](./installation-bootstrap.md) Findings note
    and the final Phase 11.4 report.
