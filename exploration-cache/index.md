...
**Last updated**: 2026-08-24 | **Sprint**: 11 complete (`f3547d4`+`f27d58f`+`d312a86`) — 2026-07-05/06 was a "Sprint de durcissement UI" (sonner toasts, shadcn Table/Tabs migration, full feature-folder split); 2026-08-24 added Docker/Compose/CI-CD deployment infrastructure (`ff26b42`) and a full Missions (M3) module redesign (registry, guided creation, detail workspace, logistics checklist migration, `/api/contacts` endpoint) — both logged in Notion under "Sprint 12"
