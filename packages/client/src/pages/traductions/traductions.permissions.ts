...
const STATUTS_MODIFIABLES: Traduction['statut'][] = ['a_reviser', 'en_relecture', 'manuelle_requise'];
...
export function canApproveTraduction(
  ...
  return STATUTS_MODIFIABLES.includes(traduction.statut) && can(user, 'TRANSLATION_REVIEW', 'TRANSLATION_APPROVE');
}
