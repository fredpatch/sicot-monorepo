...
router.get(
  '/:id/suggestions',
  requireCapability('TRANSLATION_VIEW'),
  traductionController.suggestions
);
...
router.patch(
  '/:id/archiver',
  requireCapability('TRANSLATION_ARCHIVE'),
  traductionController.archiver
);
...
router.patch(
  '/:id/restaurer',
  requireCapability('TRANSLATION_PROCESS'),
  traductionController.restaurer
);
